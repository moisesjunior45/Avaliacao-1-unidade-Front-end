let modelsJson = [
    { id: 1, name: 'Ave do Paraiso', img: '../Media/img/produtos/Flor-Ave-do-paraiso.jpg', price: [29.99, 49.99, 99.99], sizes: ['', '', ''], description: 'Com suas pétalas vibrantes e exóticas, que se assemelham às penas de um pássaro exuberante, esta flor é a personificação da elegância e da graça.' },
    { id: 2, name: 'Gengibre ornamentais', img: '../Media/img/produtos/gengibre ornamentais.jpg', price: [14.99, 29.99, 49.99], sizes: ['', '', ''], description: 'Com suas delicadas pétalas em tons vibrantes de vermelho, rosa e branco, essas flores trazem um toque de sofisticação e charme para qualquer ambiente.' },
    { id: 3, name: 'Cana indica', img: '../Media/img/produtos/cana indica.jpg', price: [21.99, 49.99, 89.99], sizes: ['', '', ''], description: 'Com suas hastes altas e elegantes, adornadas por flores vibrantes em tons de vermelho intenso, laranja ou amarelo, a Flor Cana-Índica traz um toque de exuberância tropical para qualquer ambiente.' },
    { id: 4, name: 'Costus ornamentais', img: '../Media/img/produtos/Costus ornmanetais.webp', price: [19.99, 39.99, 59.99], sizes: ['', '', ''], description: 'Com suas flores exuberantes e formas impressionantes, as Flores Costus Ornamentais trazem um toque de elegância selvagem para sua paisagem.' },
    { id: 4, name: 'Ave do paraiso', img: '../Media/img/produtos/michael-pfister-M5oHfkxQeY4-unsplash.jpg', price: [22.99, 59.99, 79.99], sizes: ['', '', ''], description: 'Com suas pétalas vibrantes e exóticas, que se assemelham às penas de um pássaro exuberante, esta flor é a personificação da elegância e da graça.' },
    { id: 4, name: 'Cana indica', img: '../Media/img/produtos/zoltan-tasi-yanhwFwyoaU-unsplash.jpg', price: [24.99, 49.99, 99.99], sizes: ['', '', ''], description: 'Com suas hastes altas e elegantes, adornadas por flores vibrantes em tons de vermelho intenso, laranja ou amarelo, a Flor Cana-Índica traz um toque de exuberância tropical para qualquer ambiente.' },
];
